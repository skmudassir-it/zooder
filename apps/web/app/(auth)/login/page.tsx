        ...
        <div className="rounded-3xl border border-border/60 bg-card shadow-sm p-8">
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-muted-foreground mt-1.5">
              Sign in to your Zooder account
            </p>
          </div>

          {/* Success banner */}
          {registered && (
            <div className="mb-6 p-3 rounded-xl bg-emerald-500/10 border border-emerald-500/20 text-emerald-600 dark:text-emerald-400 text-sm text-center">
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full py-2.5 bg-primary text-primary-foreground rounded-full font-semibold hover:opacity-90 disabled:opacity-60 transition-all flex items-center justify-center gap-2"
            >
              {loading ? (
                <>
          ...
          <div className="grid grid-cols-2 gap-3">
            <button
              ...
              className="flex items-center justify-center gap-2 px-4 py-2.5 rounded-xl border border-border/60 bg-muted/40 hover:bg-accent/50 transition-colors text-sm font-medium"
            >
